...
class CarCollection
{
    ...
    {
        if(!ascending)
            Collections.sort(cars, Comparator.comparing(Car::getPrice).thenComparing(Car::getPower).reversed());
        else
    ...
    {
        return cars.stream()
                   .filter(e -> e.getManufacturer().toLowerCase().equals(manufacturer.toLowerCase()))
